...
export const NODE_LIBRARY: NodeLibraryEntry[] = [
  ...
  workflowEntry(
    "manual_trigger",
    "Rodar agora",
    "Disparo manual com payload default opcional (testes e ad-hoc)",
    MousePointerClick,
    C_TRIGGER,
    "Gatilhos",
    "trigger",
  ...
  workflowEntry(
    "stop_and_error",
    "Parar com erro",
    "Aborta o run com mensagem custom (validation gate)",
    Octagon,
    C_END,
    "Lógica",
    "end",
  ...
  workflowEntry(
    "transform",
    "Transformar",
    "Mapper declarativo: reescreve a forma do payload sem código",
    Wand2,
    C_DATA,
    "Dados",
    "data",
  ...
  workflowEntry(
    "ai_agent",
    "Agente IA",
    "LLM com loop de ferramentas (tool calling até maxSteps)",
    Bot,
    C_AI,
    "IA",
    "ai",
